...
class UserService{
    ...
    static func updateUserDetails(em: String, dob: String, pp: String, num: String, completion: @escaping(APIResponse<Update>) -> Void){
        let params = ["email": em, "dob": dob, "phone_no": num, "profile_pic": pp,]
